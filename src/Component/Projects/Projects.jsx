...
const Projects = () => {
    return (
        <div id='projects' className="p-4 sm:p-6 md:p-8 lg:p-10 ">
            <h1 className=" text-center text-4xl m-6 font-bold">Projects</h1>
            <div className="grid  gap-6 md:grid-cols-2 lg:grid-cols-3 ">
                <div className="card w-96 bg-slate-200  shadow-xl p-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions flex grid-col md:grid-row md:justify-end gap-4">
                            ...
                            <a href="https://github.com/seyam14/FitFormaFusion-ClientSide"><button className="btn btn-secondary">Github repo</button></a>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-slate-200 shadow-xl p-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions flex grid-col md:grid-row md:justify-end gap-4">
                            ...
                            <a href="https://github.com/seyam14/UnityExchangeHub-ClientSide"><button className="btn btn-secondary">Github repo</button></a>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-slate-200 shadow-xl p-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions flex grid-col grid-col md:flex-row md:justify-end gap-4">
                            ...
                            <a href="https://github.com/seyam14/Brand-Shop-ClientSide"><button className="btn btn-secondary">Github repo</button></a>
                        </div>
                    </div>
                </div>
            </div>
