...
const Projects = () => {
    return (
        <div id='projects' className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
            <h1 className="text-white text-center text-4xl m-6 font-bold">Projects</h1>
            <div className="flex flex-col gap-6 md:flex-row md:gap-4 lg:gap-8">
                <div className="card w-full md:w-96 bg-gradient-to-b from-[#AA076B] to-[#AA076B] via-[#61045F] text-white shadow-xl p-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions flex flex-col md:flex-row md:justify-end gap-4">
